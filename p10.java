	...
	public static void region() throws InterruptedException {
		...
		if(!((region==1) || (region==2 ) || (region==3) || (region==4))) {
			System.out.println("Incorrect output, Resetting program \n\n");
			 ...
			 cities = new String[] { "Seattle, WA" , "Las Vegas, NV" , "Los Angeles, CA" , "Anchorage, AK" , "Honolulu, HI"};
			   }

			else if ( region == 2) {

			cities = new String[] { "Kansas City, MO" , "Minneapolis, MN" , "Chicago, IL" , "Detroit, MI" , "Indianapolis, IN"};
			    }
			...
			cities = new String[] { "Philadelphia, PA" , "New York, NY" , "Boston, MA" , "Providence, RI" , "Hartford, CT"};
			   }
...
System.out.println("\nHere are the cities you should travel to, organized by temperature for your needs!\n");
...
for (int d=0;d<temperature.length;d++) {
	...
	public static void orderOfSteps() throws InterruptedException {
		region();
		climateOrg();
	}
